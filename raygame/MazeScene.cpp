...
Maze::Maze()
{
	...
	TileKey map[Maze::HEIGHT][Maze::WIDTH] = {
		...
		{ w, _, w, _, _, _, _, _, _, _, _, _, w, _, _, w, _, _, _, _, _, _, _, _, _, w, _, w },
		{ w, _, w, _, _, _, _, _, _, _, _, _, w, _, _, w, _, _, _, _, _, _, _, _, _, w, _, w },
		{ w, _, w, _, _, _, _, _, _, _, _, _, w, _, _, w, _, _, _, _, _, _, _, _, _, w, _, w },
		{ w, _, w, w, w, w, w, _, _, _, _, w, w, _, _, w, w, _, _, _, _, w, w, w, w, w, _, w },
		{ w, _, _, _, _, _, _, _, _, _, _, _, w, _, _, w, _, _, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, g, _, _, _, _, w, _, _, w, _, _, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w },
		{ w, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, _, w },
